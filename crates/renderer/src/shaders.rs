...
/// Compiles and reflects a graphics shader. Public for `mltrs-cli`, which
/// drives codegen from outside this crate.
...
/// Compute equivalent of [`prepare_reflected_shader`].
