...
use mltrs::gx::model_manifest::{self as mm, Batch, Manifest, MaterialEntry, TextureEntry};
use mltrs::gx::tev_pack;
use mltrs::renderer::{
...
use mltrs::generated::shader_atlas::tev::{GXAlphaOp, GXCompare};
