...
/// The extracted cl.bdl, kept at the repo root (gitignored; see
/// `just extract-link`). CARGO_MANIFEST_DIR is <repo>/crates/convert-link.
#[cfg(test)]
pub(crate) const REAL_CL_BDL: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../assets/link/raw/cl.bdl");
