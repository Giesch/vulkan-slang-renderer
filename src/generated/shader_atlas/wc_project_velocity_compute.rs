...
//! generated from slang compute shader: wc_project_velocity.compute.slang
...
impl Shader {
    pub fn init() -> Self {
        let json_str = include_str!(concat!(
            ...
            "/shaders/compiled/wc_project_velocity.comp.json"
        ));
    ...
    fn comp_spv(&self) -> Vec<u32> {
        let bytes = include_bytes!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/shaders/compiled/wc_project_velocity.comp.spv"
        ));
