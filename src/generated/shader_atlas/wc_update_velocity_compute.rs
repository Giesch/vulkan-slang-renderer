...
const _: () = assert!(std::mem::offset_of!(Params, texel_size) == 8);
const _: () = assert!(std::mem::size_of::<glam::Vec2>() == 8);
const _: () = assert!(std::mem::offset_of!(Params, dt) == 16);
const _: () = assert!(std::mem::size_of::<f32>() == 4);
const _: () = assert!(std::mem::offset_of!(Params, mu) == 20);
const _: () = assert!(std::mem::size_of::<f32>() == 4);
const _: () = assert!(std::mem::offset_of!(Params, kappa) == 24);
const _: () = assert!(std::mem::size_of::<f32>() == 4);
const _: () = assert!(std::mem::offset_of!(Params, slope_strength) == 28);
const _: () = assert!(std::mem::size_of::<f32>() == 4);
...
pub struct Resources<'a> {
    ...
    pub u_out: &'a StorageTextureHandle,
    pub v_out: &'a StorageTextureHandle,
