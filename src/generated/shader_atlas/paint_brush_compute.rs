...
const _: () = assert!(std::mem::offset_of!(BrushParams, point_count) == 0);
const _: () = assert!(std::mem::size_of::<u32>() == 4);
const _: () = assert!(std::mem::offset_of!(BrushParams, brush_radius) == 4);
const _: () = assert!(std::mem::size_of::<f32>() == 4);
const _: () = assert!(std::mem::offset_of!(BrushParams, brush_opacity) == 8);
const _: () = assert!(std::mem::size_of::<f32>() == 4);
const _: () = assert!(std::mem::offset_of!(BrushParams, brush_pressure) == 12);
const _: () = assert!(std::mem::size_of::<f32>() == 4);
const _: () = assert!(std::mem::offset_of!(BrushParams, pigment_color_0_3) == 16);
const _: () = assert!(std::mem::size_of::<glam::Vec4>() == 16);
const _: () = assert!(std::mem::offset_of!(BrushParams, pigment_color_4_7) == 32);
const _: () = assert!(std::mem::size_of::<glam::Vec4>() == 16);
const _: () = assert!(std::mem::offset_of!(BrushParams, pigment_color_8_11) == 48);
const _: () = assert!(std::mem::size_of::<glam::Vec4>() == 16);
