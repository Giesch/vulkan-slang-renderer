...
- **Timeline + swapchain-recreate edge cases** (frame-counter increments on early-return paths; the "advance counters BEFORE present" comment in `draw_frame` shows this area has bitten before): resize storms tested by eye 2026-08-28.
